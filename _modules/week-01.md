  ...
  - date: 2026-3-30
    events:
      - name: LEC 1
        type: lecture
        title: Introduction
        url: http://datahub.ucsd.edu/user-redirect/git-sync?repo=https://github.com/dsc-courses/dsc10-2026-sp&subPath=lectures/lec01/lec01-live.ipynb
  ...
  - date: 2026-4-1
    events:
      - name: LEC 2
        ...
        url: http://datahub.ucsd.edu/user-redirect/git-sync?repo=https://github.com/dsc-courses/dsc10-2026-sp&subPath=lectures/lec02/lec02-live.ipynb
  ...
  - date: 2026-4-2
    events:
      - name: SUR
        ...
        url: https://forms.gle/HE1a1V7rvu5BCuSZ7
      - name: SYL
        type: survey
        title: Syllabus Check
        url: https://docs.google.com/forms/d/e/1FAIpQLScOVK4Q8Xe9T0xQ4RQBB2ZAkySvnWHDCQK_k_33nhw0zDvkSQ/viewform?usp=dialog
  - date: 2026-4-3
    events:
      - name: LEC 3
        type: lecture
        title: Strings, Lists, and Arrays
        url: http://datahub.ucsd.edu/user-redirect/git-sync?repo=https://github.com/dsc-courses/dsc10-2026-sp&subPath=lectures/lec03/lec03-live.ipynb
